...
const ProductDetail = () => {
  ...
  return (
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ color: '#ddddea', marginBottom: '20px', fontSize: '0.95rem' }}>
        <Link to="/" style={{ color: '#53749a' }}>Home</Link> / <Link to="/shop" style={{ color: '#53749a' }}>Shop</Link> / {product.category} / <span style={{ color: '#fff' }}>{product.name}</span>
      </div>
