...
}, [user, navigate, logout]); // ✅ FIXED: added logout
...
<p style={{ color: '#a1a1aa', fontSize: '1.2rem', marginBottom: '15px' }}> <strong>Email:</strong> {user.email} </p> <span style={badgeStyle}>
Account Type: {user.role.toUpperCase()} </span> </div>
...
```
  ...
  <h3 style={{ color: '#1674f9', marginBottom: '20px', fontSize: '1.5rem' }}>
    Order History
  </h3>
